...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('First image on Quote Page', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'example_text',
		'std' => 'Default Value',
		'type' => 'upload');
  $options[] = array(
		'name' => __('Second image on Quote Page', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'example_text2',
		'std' => 'Default Value2',
		'type' => 'upload');
   ...
   $options[] = array(
		'name' => __('First image on banner', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'banner1',
		'std' => 'Default Value1',
		'type' => 'upload');
   $options[] = array(
		'name' => __('Second image on banner', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'banner2',
		'std' => 'Default Value2',
		'type' => 'upload');
   $options[] = array(
		'name' => __('Third image on banner', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'banner3',
		'std' => 'Default Value3',
		'type' => 'upload');
   $options[] = array(
		'name' => __('Fourth image on banner', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'banner4',
		'std' => 'Default Value4',
		'type' => 'upload');
   $options[] = array(
		'name' => __('Fifth image on banner', 'options_check'),
		'desc' => __('Paste image url', 'options_check'),
		'id' => 'banner5',
		'std' => 'Default Value5',
		'type' => 'upload');
